# Prácticas del Equipo — 260918-matchday-prizes-calc
> Re-run brownfield. Línea base: `aidlc/spaces/default/memory/team.md` y
> `project.md`. Aquí se reafirman las 5 secciones y se matizan **solo** donde la
> evidencia del intent de premios lo exige (Testing Posture y Way of Working).
> Integración final del lead (pipeline-deploy): incorpora las 3 contribuciones
> ciegas (quality, developer, devsecops) y las respuestas autoritativas de la
> interview (Q1=A extracción a función pura; Q2=A caracterizar TODAS las ramas;
> Q3=C incertidumbre abierta a requisitos; Q4=A 80% referencia no-bloqueante;
> Q5=A paridad `--cov` de `verify` diferida; Q6=A deuda de "puntos"/identidad
> fuera de alcance). Pendiente del gate de afirmación.
