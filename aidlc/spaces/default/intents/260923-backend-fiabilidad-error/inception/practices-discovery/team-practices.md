# Prácticas del Equipo — Fiabilidad backend (FR3.2 + FR4)

> **Re-run brownfield.** Las prácticas ya afirmadas del equipo son la línea base
> vigente (`aidlc/spaces/default/memory/team.md` + `project.md`). Este borrador
> las **arrastra sin cambios** y sólo añade el matiz estrecho que implica este
> intent (manejo de errores FR3.2 + contratos de integración FR4). No se inventan
> prácticas nuevas.
